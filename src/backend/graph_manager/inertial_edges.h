...
class EdgeImuPreintegrationBetweenRelativePose: public slam_solver::Edge<Scalar> {
...
public:
    EdgeImuPreintegrationBetweenRelativePose(const ImuPreintegrateBlock<DorF> &imu_block, const Vec3 &gravity_w): slam_solver::Edge<Scalar>(15, 10) {
